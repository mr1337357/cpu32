...
HD_PWD='C:/Users/misspapaya/projects/cpu32/riscv/riscv_rtl/riscv_rtl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log basys3top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source basys3top.tcl
