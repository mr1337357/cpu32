...
HD_PWD='C:/Users/misspapaya/projects/cpu32/riscv/riscv_rtl/riscv_rtl.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log basys3top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source basys3top.tcl -notrace
